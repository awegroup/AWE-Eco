function inp = eco_inputs
      ...
      case 'code'
          ...
          switch eco_settings.power
              case 'FG'
                  ...
                  % ground station
                  inp.gStation.uc.E_rated = inp.kite.structure.m * 9.81*inp.kite.structure.b*5/3.6e6; % kWh
                  inp.gStation.uc.f_repl = -1;
              ...
              case  'GG' 
                  switch eco_settings.wing
                      case 'fixed'
                          ...
                          inp.kite.prop.P = 1e3; % W
                          inp.kite.batt.E = 1; % kWh
                          ...
                          inp.system.P_out_rated = 1.87e+06; % W
                          inp.system.P = [0	0	0	0	0	145524.730974731	288495.257975699	488571.542997977	727335.279338411	953941.843495889	1000000.00000461	999999.999798969	1000000.00001413	1000000.00000000	1000000.00000046	1000000.00000080	1000000.00000000	1000000.00000017	1000000.00000000	999999.999732790	999999.999965783	999999.999995972	999999.999999559	999999.999999956	1000000.00000000]; % W
                          inp.system.P_rated = 1e+06; % W
                      ...
                      case 'soft'
                          ...
                          % Ground station
                          inp.gStation.uc.E_rated = 1.1*inp.system.P_rated * 25/3600/1e3; % kWh
                          inp.gStation.uc.E_ex = inp.gStation.uc.E_rated/2; % kWh
                          inp.gStation.uc.f_repl = -1;
  ...
  % WACC
  inp.business.r = inp.business.DtoE/(1+ inp.business.DtoE)*inp.business.r_d*(1-inp.business.Tc) + 1/(1+inp.business.DtoE)*inp.business.r_e;
