function inp = eco_system_inputs_example
  ...
  eco_settings.name             = 'example_system';
  eco_settings.input_cost_file  = 'eco_cost_inputs_FG'; % eco_cost_inputs_GG_fixed || eco_cost_inputs_FG || eco_cost_inputs_GG_soft || set the input file
  eco_settings.input_model_file = 'eco_system_inputs_FG_example'; % code || eco_system_inputs_GG_fixed_example || eco_system_inputs_FG_example || eco_system_inputs_GG_soft_example || set the input file
